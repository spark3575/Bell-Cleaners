...
let signInAlertTitle = "Sign In Failed"
let createAccountAlertTitle = "Create Account Failed"
let accountAlertMessage = "Please check your email address or password"
let bellCleanersSegue = "BellCleanersVC"
let accessAccountSegue = "AccessAccountVC"
let myAccountSegue = "MyAccountVC"
let createAccountSegue = "CreateAccountVC"
